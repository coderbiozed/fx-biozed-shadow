...
<section>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class='sec_top'>
                    <h2 class='sec_head'><span class='br_sp'>Enjoy</span> exciting welcome bonuses<span class='c_lp'>!</span></h2>
            ...
            <div class="col-md-6 col-lg-4 col-xxl-3">
                ...
                <div class='bon_card'>
                    ...
                    <div class='bon_car_btns'>
                        ...
                        <a href='{{ url('welcome_bonuses_details/'.$bonus->id)}}' class="bon_card_btn">Read details <span class='c_lp'>
                                <i class="fa-regular fa-circle-right"></i>
                            </span></a>
                    </div>
                </div>             
