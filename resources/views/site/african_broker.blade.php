...
<section class="sec_to_ten_bro">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class='sec_top'>
                  <?php $count = $african_brokers->count(); ?>
                    <h2 class='sec_head'><span class='br_sp'>Top <?php echo  $count ?></span> African Forex Brokers In The World<span class='c_lp'>!</span></h2>
            ...
            <div class="col-lg-12">
                <div class='br_ta_main'>
                    <div>
                      <h3><span class='hm_sp'>African</span> forex brokers</h3>
                    </div>
                    <div>
                      <table class='top_te_br_ta'>
                          ...
                          <tbody>
                            @foreach ($african_brokers as $key=>$broker)
                            <tr>
                              <td>{{++$key}}.</td>
